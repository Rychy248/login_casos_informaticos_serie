...
class Cases
{
    ...
    public function readCase($case_id=null)
    {
        ...
        try{
            $this->db_connection = new PDO ("mysql:host=".DB_HOST.";port=".DB_PORT.";dbname=".DB_NAME.";",DB_USER,DB_PASS);
            ...
            $sql = $sql.'c.image FROM case_t AS c';
            if (is_null($case_id)){
                $sql = $sql.';';
            }else{
    ...
    public function deleteCase($case_id=null)
    {
        ...
        try{
            ...
            $sql = 'DELETE FROM case_t WHERE case_id='.$case_id;
            $sql = $sql.';';
    ...
    public function registerCase()
    {
            ...
            try{
                ...
                // echo "<hr> <h1>Llegamos aqui</h1>";
                $sql = 'INSERT INTO case_t (subject, description, price, case_status, case_priority, image) VALUES(';
                $sql = $sql."'".$subject."',";
                $sql = $sql."'".$description."',";
                $sql = $sql."'".$price."',";
                $sql = $sql."".$status.",";
