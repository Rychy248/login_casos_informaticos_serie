...
<div class="case-container">
    <h1 class="white delete-space case-title-h1">Caso "<span class="resalt-light"><?php echo $subject;?></span>" <span class="resalt-medium-light"> Actualizado!</span></h1>	
	<br><br>
	...
	<div class="elemento">
		...
		<div class="elemento">
        	<input type="submit" name="submit" class="input-submit-reupdate" value="Reactualizar">
		</div>
	</form>
</div>
